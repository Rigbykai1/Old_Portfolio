...
const ImagesCarrouselModal = (props) => {
  ...
  return (
    <dialog id={id} className="modal backdrop-blur-lg">
      <div className="modal-box w-11/12 max-w-1xl bg-black/50 p-2">
        <div className="carousel rounded-xl">
          <a id={idCatcher(images[currentImageIndex])} className="carousel-item w-fit justify-center" onClick={() => openImage(images[currentImageIndex])}>
...
export default ImagesCarrouselModal;
