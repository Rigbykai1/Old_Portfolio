            ...
            <div className="flex flex-col items-center">
                ...
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-black/50 scale-105 text-white">
                    <form className="card-body">
                        ...
                        <div className="form-control">
                            <textarea className="textarea textarea-bordered bg-transparent" placeholder="Mensaje"></textarea>
                        </div>


                        <div className="form-control mt-6">
                            <button className="btn btn-outline hover:glass hover:scale-105 hover:text-white">Enviar</button>
                        </div>
                    </form>
                </div>
            </div>
